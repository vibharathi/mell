        ...
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl pt-12 text-primary">
                Medical Equipment Lending Library
              </h1>
              <p className="mx-auto text-gray-500 md:text-xl dark:text-gray-400">
                Free access to essential medical equipment for individuals and
                families in need. Building a stronger, more supportive community
